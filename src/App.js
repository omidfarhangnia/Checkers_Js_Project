...
import { ShowWinner } from "./project-files/Page";
...
function App() {
  ...
  const [winner, setWinner] = useState({
    name: "",
    RemianedKingsNumber: 0,
    RemainedPiecesNumber: 0,
  });
      ...
      <Page>
        {winner.name === "" ? (
          ...
          <ShowWinner
            ...
            RemainedPiecesNumber={winner.RemainedPiecesNumber}
            RemianedKingsNumber={winner.RemianedKingsNumber}
          />
        )}
      </Page>
    </BoardPartContext.Provider>
